...
<div class="row pt-5">
    <div class="col-lg-9 pt-3" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        ...
        <p class="text-muted">Se muestra el formulario para ver el detalle de un agregado</p>
    </div>
...
{{-- contenido --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="pb-3">
                                ...
                                <label class="form-control"  maxlength="2000" placeholder="Máximo 2000 caracteres" name="descripcion" id="descripcion_id" style="height: 80px;">{{$admin_agregado->descripcion}}</label>
                                @error('descripcion')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="pb-3">
                                ...
                                <label class="form-control" name="contenido" >{!!$admin_agregado->contenido!!}</label>
                                @error('contenido')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
    ...
    <div class="pb-3 text-end">
        <a href="{{url('admin-agregados')}}" class="btn btn-outline-secondary">Atras</a>
    </div>
{{-- fin contenido --}}
@endsection
