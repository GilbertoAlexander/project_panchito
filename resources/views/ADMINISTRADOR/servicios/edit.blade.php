...
<div class="row pt-5">
    <div class="col-lg-9 pt-3" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        ...
        <p class="text-muted">Se muestra el formulario para actualizar un servicio</p>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="pb-3">
                                ...
                                <input type="text" name="precio" id="precio_id" value="{{$admin_servicio->precio}}" class="form-control form-control-sm" maxLength="100">
                                @error('precio')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
