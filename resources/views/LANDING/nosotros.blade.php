                ...
                <div class="col-12 col-md-6 mb-3">
                    <div class="card border-0 card-cuantica h-100 shadow-sm mb-3 d-flex justify-content-center align-items-center">
                        ...
                        <div class="col-8">
                            ...
                            <p class="card-text description__cuantica" align="justify">{{$admin_empresa->mision}}</p>
                            </div>
                        </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 mb-3">
                    <div class="card border-0 card-cuantica h-100 shadow-sm mb-3 d-flex justify-content-center align-items-center" ">
                        ...
                        <div class="col-8">
                            ...
                            <p class="card-text description__cuantica" align="justify">{{$admin_empresa->vision}}</p>
                            </div>
                        </div>
                        </div>
                    </div>
                ...
                @foreach ($equipos as $equipo)
                    <div class="col-12 col-md-4 my-2" data-aos="fade-up" data-aos-duration="500">
                        <div class="card border-4 borde-right-primary shadow-sm rounded">
                            <div class="row">
                                <div class="col-4">
                                    <img src="images/equipos/{{$equipo->imagen}}" class="rounded-start" width="100" height="100" alt="">
                                </div>
                                <div class="col-8 d-flex">
                                    <div class="align-self-center">
                                        <span class="d-block fw-bold text-uppercase">{{$equipo->name}}</span>
                                        <span class="d-block text-uppercase text-muted">{{$equipo->cargo}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
