...
// LANDING
    ...
    Route::get('/confirmacion_cotizacion/cotizacion-pdf/{confirmacion_cotizacion}', [landingserviciosController::class, 'getCotizacionServicioPdf'])->name('reporte_cotizacion_servicio.pdf'); 
